...
const specials = [
  ...
  },
  {
    ...
    price: 9.99,
    description:
      "A classic Italian appetizer of toasted bread, " +
  ...
  },
  {
    ...
    price: 6.99,
    description:
      "A delicious lemon dessert with a hint of vanilla and " +
      "a touch of cinnamon. ",
    img: LemonDessertImg,
  },
];
...
function Specials() {
  ...
  return (
    <VStack
      ...
      margin="1em"
    >
      <HStack spacing={8} justifyContent="space-between" width="95%">
